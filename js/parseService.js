...
app.factory('parseService', function($http){
  ...
  //equal to another object which a key of text and a value of the message being passed to parse.
  ...
  service.postData = function (message) {
    var data = {
      text: message
    }
    return $http.post('https://api.parse.com/1/classes/chat', data);
  }
