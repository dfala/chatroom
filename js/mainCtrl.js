...
app.controller('mainCtrl', function($scope, parseService){
  //In your controller you'll have a getParseData function and a postData function, but
  //should be placed on $scope.
  ...
  var getParseData = function () {
    // var request = parseService.getData();
    // console.log(request);
  ...
  //The postData function will take whatever the user typed in (hint: look at the html and see
  //what ng-model correlates to on the input box),
  //pass that text to the postData method on the parseService object which will then post it to
  //the parse backend.
